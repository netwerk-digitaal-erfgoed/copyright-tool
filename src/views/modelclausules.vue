    ...
    >
      <div class="column-result">
        <div class="container container-small padding-top-null">
            <h2>Model-schenkingsovereenkomst / Bruikleenovereenkomst</h2>
            <p>Bij de schenkingen of bruikleen van objecten verkrijgt de erfgoedinstelling soms werken die nog auteursrechtelijk beschermd zijn. Het kan gaan om een uniek fysiek werk of (bij werk in oplage of born-digital materiaal) een kopie van het werk. Het verkrijgen van zo’n werk betekent niet dat de erfgoedinstelling ook het auteursrecht erop heeft verkregen.</p>
            ...
            <p>Voor overdracht van rechten is een akte nodig; een overeenkomst. Dit heet het schriftelijkheidsvereiste. Uiteraard moet de schenker wel over de rechten beschikken om deze te kunnen overdragen. Dit is niet altijd het geval, maar soms wel mogelijk wanneer de schenker de maker van het werk is. Daarnaast moet de schenker wilsbekwaam (bij volle verstand) zijn.</p>
            <p>Een schenker wil het auteursrecht niet altijd overdragen aan een erfgoedinstelling, bijvoorbeeld omdat deze het werk zelf nog wil exploiteren. In zo'n geval kan er nagedacht worden over een licentie (toestemming voor bepaalde vormen van gebruik) voor de instelling. Hieronder worden voorbeeldbepalingen gegeven voor beide situaties.&nbsp;</p>
            <p>Let op:</p>
            <ul>
                <li>
            ...
            <p>"Creative Commons-Licentie": De specifieke Creative Commons-licentie die van toepassing is op het Geschonken Werk, zoals [bijvoorbeeld CC BY-SA 4.0, te vinden op https://creativecommons.org/licenses/by-sa/4.0/].
            </p>
            <ol>
                <li>
